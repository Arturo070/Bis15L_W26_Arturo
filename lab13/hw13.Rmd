...
#There is 528196 NA's in the data set. 
```{r}
sum(is.na(amniota))
miss_var_summary(amniota)
```
...
#Variables such as subspecies, female body at maturity, female svl at maturity, fledling mass, and other associated reproeductive traits have the most NA's. 
...
#Reptilia has the most missing values for egg mass, followed by Mallalia, and Aves. This doesnt make the most sense biologically as reptiles and birds lay eggs, so they are less expected to have less NA's in egg mass. Meanwhile, Mammals dont really lay eggs so many NA's were expected. This may mean what they use to determine NA's may vary across on the taxonomic classes. 
