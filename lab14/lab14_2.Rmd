...
## Shiny App Skeleton
A shiny app consists of a user interface (ui) function, server function (#what its gonna do), and run function.
...
#Makes the Y-value drop down menu
```{r, eval=F, echo=T}
library(shiny)
