...
```{r}
Mountain_Names <- c("mount_everest", "K2", "Kangchenjunga", "Lhotse", "Makalu")
<<<<<<< HEAD
H_feet <- c(29032,28251,28169,27940,27838)
=======
H_feet <- c(29032,28251,29189,27940,27838)
>>>>>>> 433b963ba313641c2f1664c4f1def1cde5c4b2a5
H_meters <- c(8849,8611,8586,8516,8485)
```
...
mountains <- tibble(
  ...
  H_meters = H_meters)
=======
mountains <- tibble(Mountain_Names,H_feet,H_meters)
>>>>>>> 433b963ba313641c2f1664c4f1def1cde5c4b2a5
```
...
```{r}
<<<<<<< HEAD
summits <- c(12884, 800, 532, 950, 475)
...
```{r}
<<<<<<< HEAD
#Mount_Everest has the highest number of fatalities
fatalities <- c(344, 90, 50, 96, 21)
...
```{r}
<<<<<<< HEAD
mountains$fatality_rate <- fatalities/summits
=======
